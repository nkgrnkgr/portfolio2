...
export const CATEGORY_NAME: Record<TimelineCategory, React.ReactNode> = {
  [TIMELINE_CATEGORY.RELEASE]: <Text color="gray.900">🎉Published🎉</Text>,
  [TIMELINE_CATEGORY.ZENN]: (
    <Text color="gray.900">Published a post on zenn.dev</Text>
  ),
  [TIMELINE_CATEGORY.SPEAKER_DECK]: (
    <Text color="gray.900">Published a slide on speakerdeck.com</Text>
  ),
  [TIMELINE_CATEGORY.ARTICLE]: <Text color="gray.900">Published a post</Text>,
} as const;
